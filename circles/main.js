...
var audios = {
	...
	"tone": new Audio(`audio/click.mp3`)
};
...
var tutorial = {
	texts: [
		...
		`press enter to revisit a completed zone`,
		`press escape to leave a zone`
	],
	hasDone: [
		false, 
		false,
...
function handleKeyPress(a) {
	...
	switch (a.keyCode) {
		...
		//esc
		case 27:
			//just kill the player to get out of the level
			game_map.playerObj.energy = -1 + 12 * (game_map.constructor.name == "Level_Inverse");
			tutorial.hasDone[3] = true;
			break;
